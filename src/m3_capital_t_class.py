    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        self.a = rg.Point(intersection_center.x + width/2, intersection_center.y + letter_thickness/2)
        self.b = rg.Point(intersection_center.x - width/2, intersection_center.y - letter_thickness/2)
        self.h_rect = rg.Rectangle(self.a, self.b)

        self.c = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y - letter_thickness/2)
        self.d = rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y + (height - (letter_thickness/2)))
        self.v_rect = rg.Rectangle(self.c, self.d)
    ...
    def move_by(self, dx, dy):
        ...
        self.a = rg.Point(self.a.x + dx, self.a.y + dy)
        self.b = rg.Point(self.b.x + dx, self.b.y + dy)
        self.c = rg.Point(self.c.x + dx, self.c.y + dy)
        self.d = rg.Point(self.d.x + dx, self.d.y + dy)
